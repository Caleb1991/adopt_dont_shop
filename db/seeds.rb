...
@app_4 = Application.create!(name: 'Larry', state: 'Colorado', city: 'Rifle', zip_code: 80002, address: '1324 Garrison St.')
@app_4 = Application.create!(name: 'Hawky McHawkerton', state: 'Colorado', city: 'Black Hawk', zip_code: 80233, address: '8473 Garrison St.')
@app_4 = Application.create!(name: 'Big Rick', state: 'Colorado', city: 'Aurora', zip_code: 18232, address: '2039 Garrison St.')
@app_4 = Application.create!(name: 'Lando', state: 'Colorado', city: 'Commerce City', zip_code: 12433, address: '9033 Garrison St.')
@app_4 = Application.create!(name: 'Luke', state: 'Colorado', city: 'Lakewood', zip_code: 99948, address: '8293 Garrison St.')
